                        ...
                        <Row>
                            <Col md={7}>
                                ...
                                <div className="d-flex align-items-center">
                                    <div className="d-flex align-items-center">
                                        <h4 style={{marginRight: '5px', fontWeight: '700'}}>Cooking time:</h4>
                                        <h4> 2h 30m</h4>
                                    </div>
                                </div>
                    ...
                    <Col  md={5}>
                        ...
                        <Row className="justify-content-center" style={{ marginBottom: '25px' }}>
                            <Col xs={6}>
                                {favorite ? (
                                    <div className="d-flex align-items-center">
                                        <div className="d-flex align-items-center" onClick={FavoriteToFalse}>
                                            <FavoriteIcon
                                    ...
                                    <div className="d-flex align-items-center">
                                        <div className="d-flex align-items-center" onClick={FavoriteToTrue}>
                                            <FavoriteBorderIcon
                                                className="float-start"
                                                style={{ marginRight: '5px', fontSize: '2rem' }}
                                                color="error"
                                            />
                                            <h3 style={{ fontWeight: 'bold', textAlign: 'center' }}>3</h3>
                                        </div>
                                    </div>
                                )}
                            </Col>
                            ...
                            <Col xs={6}>
                                <h4 style={{ fontWeight: 'bold', textAlign: 'right'  }}>mm/dd/yy</h4>
                            </Col>
                        </Row>
